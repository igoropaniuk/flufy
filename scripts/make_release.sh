...
git tag -a "${TAG}" -m "flufy v${VERSION}"
ok "Tag ${TAG} created"
...
echo "Verify at: https://test.pypi.org/project/flufy/${VERSION}/"
...
echo "Verify at: https://pypi.org/project/flufy/${VERSION}/"
